...
import 'package:pcp_flutter/app/modules/grupo_de_recurso/external/datasources/remote/grupo_de_recurso_datasource_impl.dart';
...
void main() {
  ...
  group('get list', () {
    test('deve retornar uma lista de grupo de recursos', () async {
      when(() => clientService.request(any()))
          .thenAnswer((_) async => const ClientResponse(data: gruposDeRecursosSuccessData, statusCode: 200));
  ...
  group('get item', () {
    test('deve retornar um grupo de recursos', () async {
      when(() => clientService.request(any()))
          .thenAnswer((_) async => const ClientResponse(data: grupoDeRecursoSuccessData, statusCode: 200));
  ...
  group('insert item', () {
    test('deve inserir um grupo de recursos', () async {
      ...
      final result = await datasource.insertItem(GrupoDeRecursoFactory.create());
  ...
  group('put item', () {
    test('deve atualizar um grupo de recurso', () async {
      ...
      final result = await datasource.updateItem(GrupoDeRecursoFactory.create(id: '00000000-0000-0000-0000-000000000001'));
