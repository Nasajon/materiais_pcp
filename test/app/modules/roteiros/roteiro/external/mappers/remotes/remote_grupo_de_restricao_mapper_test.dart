...
import 'package:pcp_flutter/app/modules/roteiro/external/mappers/remotes/remote_grupo_de_restricao_mapper.dart';

void main() {
  test('Deve converter um Map em GrupoDeRestricaoEntity', () async {
