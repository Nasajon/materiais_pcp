...
import 'package:pcp_flutter/app/modules/turno_de_trabalho/presenter/ui/widgets/turno_trabalho_item_widget.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            CustomPrimaryButton(
              ...
              onPressed: () => Modular.to.pushNamed(NavigationRouter.turnosDeTrabalhosModule.createPath),
            )
          ],
        ),
      ),
