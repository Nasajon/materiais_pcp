...
import 'package:pcp_flutter/app/modules/turno_de_trabalho/presenter/ui/web/widgets/desktop_horario_form_widget.dart';
import 'package:pcp_flutter/app/modules/turno_de_trabalho/presenter/ui/web/widgets/desktop_turno_trabalho_dados_gerais_form_widget.dart';
      ...
      bottomNavigationBar: TripleBuilder<InserirEditarTurnoTrabalhoStore, TurnoTrabalhoAggregate?>(
        ...
        builder: (context, triple) {
          ...
          if (!triple.isLoading && turnoTrabalho != null) {
            ...
            checkPreviousRouteWeb(NavigationRouter.turnosDeTrabalhosModule.path);
