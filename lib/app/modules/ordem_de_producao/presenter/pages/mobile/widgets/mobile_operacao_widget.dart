...
import 'package:pcp_flutter/app/modules/ordem_de_producao/presenter/pages/mobile/widgets/mobile_material_dialog_widget.dart';
import 'package:pcp_flutter/app/modules/ordem_de_producao/presenter/stores/get_operacao_store.dart';

class MobileOperacaoWidget extends StatelessWidget {
  final GetOperacaoStore getOperacaoStore;

  const MobileOperacaoWidget({
    Key? key,
                    ...
                    showDialog(
                      ...
                      builder: (context) {
                        return Dialog.fullscreen(
                          child: MobileMaterialDialogWidget(materiais: operacao.materiais),
                        );
                      },
                    );
                  },
