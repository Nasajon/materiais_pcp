    ...
    return TripleBuilder<DeletarRecursoStore, bool>(
        ...
        builder: (context, triple) {
          ...
          return ListTileWidget(
            ...
            subtitle: '${translation.fields.grupoDeRecurso}: ${recurso.grupoDeRecurso.nome}',
            trailing: !triple.isLoading
                ? PopupMenuButton(
                    ...
                    onSelected: (value) async {
                      if (value == 1) {
                        await Modular.to.pushNamed(NavigationRouter.recursosModule.updatePath(recurso.id ?? ''));
