...
import '../../infra/datasources/grupo_de_recurso_datasource.dart';
import '../mappers/grupo_de_recurso_mapper.dart';
  ...
  Future<List<GrupoDeRecurso>> getList(String? search) async {
    try {
      ...
      return (response.data as List)
          .map((e) => GrupoDeRecursoMapper.fromMap(e))
          .toList();
    } on Failure {
      rethrow;
      ...
      return Future.error(UnknownError(
          ...
          label: 'GrupoDeRecursoDatasourceImpl-getList'));
    }
  }
  ...
  Future<GrupoDeRecurso> getItem(String id) async {
    try {
      ...
      return Future.error(UnknownError(
          exception: exception,
          stackTrace: stacktrace,
          label: 'GrupoDeRecursoDatasourceImpl-getItem'));
    }
  }
  ...
  Future<GrupoDeRecurso> insertItem(GrupoDeRecurso grupoDeRecurso) async {
    try {
      ...
      return Future.error(UnknownError(
          exception: exception,
          stackTrace: stacktrace,
          label: 'GrupoDeRecursoDatasourceImpl-insertItem'));
    }
  }
  ...
  Future<GrupoDeRecurso> updateItem(GrupoDeRecurso grupoDeRecurso) async {
    try {
      ...
      return Future.error(UnknownError(
          exception: exception,
          stackTrace: stacktrace,
          label: 'GrupoDeRecursoDatasourceImpl-updateItem'));
    }
  }
}
