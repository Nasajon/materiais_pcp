...
import 'package:pcp_flutter/app/modules/grupo_de_recurso/presenter/stores/states/grupo_de_recurso_state.dart';
import 'package:pcp_flutter/app/modules/grupo_de_recurso/presenter/ui/widgets/grupo_de_recurso_item_widget.dart';
                  ...
                  onState: (context, state) {
                    final createGrupoDeRecursoButton = Center(
                      child: CustomPrimaryButton(
                        ...
                        onPressed: () async {
                          await Modular.to.pushNamed(NavigationRouter.gruposDeRecursosModule.createPath);
