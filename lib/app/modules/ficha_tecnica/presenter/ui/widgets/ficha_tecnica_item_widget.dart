          ...
          return ListTileWidget(
            ...
            trailing: !triple.isLoading
                ? PopupMenuButton(
                    ...
                    onSelected: (value) {
                      if (value == 1) {
                        Modular.to.pushNamed(NavigationRouter.fichasTecnicasModule.updatePath(fichaTecnica.id));
                      } else if (value == 2) {
                        Asuka.showDialog(
                          barrierColor: Colors.black38,
                          builder: (context) {
            ...
            onTap: () => !triple.isLoading ? Modular.to.pushNamed(NavigationRouter.fichasTecnicasModule.updatePath(fichaTecnica.id)) : null,
          );
        });
  }
}
