...
import 'package:pcp_flutter/app/modules/ficha_tecnica/presenter/ui/widgets/ficha_tecnica_item_widget.dart';
        ...
        child: Row(
          ...
          children: [
            ...
            CustomPrimaryButton(
              ...
              onPressed: () => Modular.to.pushNamed(NavigationRouter.fichasTecnicasModule.createPath),
            )
          ],
        ),
      ),
