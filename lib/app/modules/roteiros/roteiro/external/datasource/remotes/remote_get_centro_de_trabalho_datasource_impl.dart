...
class RemoteGetCentroDeTrabalhoDatasourceImpl implements RemoteGetCentroDeTrabalhoDatasource {
  ...
  RemoteGetCentroDeTrabalhoDatasourceImpl(this._clientService);

  List<Interceptor> interceptors = [ApiKeyInterceptor(), EntidadesEmpresariaisInterceptor()];

  @override
  Future<List<CentroDeTrabalhoEntity>> call(String search) async {
    try {
      ...
      final data = List.from(response.data).map((map) => RemoteCentroDeTrabalhoMapper.fromMapToCentroDeTrabalho(map)).toList();
