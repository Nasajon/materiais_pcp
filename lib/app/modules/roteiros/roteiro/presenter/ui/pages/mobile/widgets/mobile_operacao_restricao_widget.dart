...
import 'package:pcp_flutter/app/modules/roteiros/roteiro/presenter/ui/pages/mobile/widgets/mobile_operacao_editar_restricao_widget.dart';

class MobileOperacaoRestricaoWidget extends StatefulWidget {
  ...
  const MobileOperacaoRestricaoWidget({
    Key? key,
  ...
  @override
  State<MobileOperacaoRestricaoWidget> createState() => _MobileOperacaoRestricaoWidgetState();
}

class _MobileOperacaoRestricaoWidgetState extends State<MobileOperacaoRestricaoWidget> {
  @override
                  ...
                  CustomTextButton(
                    ...
                    onPressed: () async {
                      final responseModal = await showDialog(
                        ...
                        builder: (context) {
                          return Dialog(
                            child: MobileOperacaoEditarRestricaoWidget(
