...
import 'package:pcp_flutter/app/modules/roteiros/roteiro/presenter/ui/pages/mobile/widgets/mobile_operacao_selecionar_materiais_widget.dart';

class MobileOperacaoMaterialFormWidget extends StatefulWidget {
  final OperacaoController operacaoController;
  final GetMaterialStore getMaterialStore;
  final GetProdutoStore getProdutoStore;

  const MobileOperacaoMaterialFormWidget({
    Key? key,
  ...
  @override
  State<MobileOperacaoMaterialFormWidget> createState() => _MobileOperacaoMaterialFormWidgetState();
}

class _MobileOperacaoMaterialFormWidgetState extends State<MobileOperacaoMaterialFormWidget> {
  Disposer? disposer;
                      ...
                      child: CustomOutlinedButton(
                        ...
                        onPressed: () async {
                          final responseModal = await showDialog(
                            context: context,
                            builder: (context) => MobileOperacaoSelecionarMateriaisWidget(
                  ...
                  Flexible(
                    child: DoubleTextFormFieldWidget(
                      ...
                      onChanged: (value) {
                        ...
                        final index =
                            operacaoController.operacao.materiais.indexWhere((element) => element.produto.id == material.produto.id);
