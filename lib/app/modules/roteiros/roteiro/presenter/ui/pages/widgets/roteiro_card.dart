...
class RoteiroCard extends StatelessWidget implements CardWidget {
  final BuildContext context;

  RoteiroCard({Key? key, required this.context}) : super(key: key) {
    titulo = translation.titles.roteiroDeProducao;
  ...
  @override
  String get codigo => 'materiais_pcp_roteiro';
  @override
  ...
  @override
  void onPressed() {
    Modular.to.pushNamed('/pcp/roteiro/');
  }
