              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${indisponibilidade.periodoInicial.dateFormat()} à ${indisponibilidade.periodoInicial.dateFormat()}',
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${indisponibilidade.horarioInicial?.name ?? ''} - ${indisponibilidade.horarioFinal?.name ?? ''}',
                      style: themeData.textTheme.bodyLarge?.copyWith(
                        fontSize: 16,
                        fontWeight: FontWeight.w700,
                      ),
