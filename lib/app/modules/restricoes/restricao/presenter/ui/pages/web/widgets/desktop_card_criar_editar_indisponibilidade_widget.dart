        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Flexible(
                  child: DropdownButtonWidget<HorarioEnum>(
                    label: l10n.fields.horarioInicial,
                    value: indisponibilidade?.horarioInicial,
                    items:
                        HorarioEnum.values.map<DropdownItem<HorarioEnum>>((tipo) => DropdownItem(value: tipo, label: tipo.name)).toList(),
                    isRequiredField: true,
                    errorMessage: l10n.messages.errorCampoObrigatorio,
                    onSelected: (value) => restricaoFormController.indisponibilidade = indisponibilidade?.copyWith(horarioInicial: value),
                  ),
                ),
                ...
                Flexible(
                  child: DropdownButtonWidget<HorarioEnum>(
                    ...
                    value: indisponibilidade?.horarioFinal,
                    items:
                        HorarioEnum.values.map<DropdownItem<HorarioEnum>>((tipo) => DropdownItem(value: tipo, label: tipo.name)).toList(),
                    isRequiredField: true,
                    errorMessage: l10n.messages.errorCampoObrigatorio,
                    onSelected: (value) => restricaoFormController.indisponibilidade = indisponibilidade?.copyWith(horarioFinal: value),
                  ),
                ),
              ],
            ),
