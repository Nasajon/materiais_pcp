        ...
        builder: (context, triple) {
          if (triple.state && !triple.isLoading) {
            ...
            NotificationSnackBar.showSnackBar(
              translation.messages.excluiuAEntidadeComSucesso(translation.fields.restricao, ArtigoEnum.artigoFeminino),
              themeData: themeData,
            );
          }
          ...
          return ListTileWidget(
            ...
            subtitle: '${translation.fields.grupoDeRestricao}: ${restricao.grupoDeRestricao?.descricao ?? ''}',
            trailing: !triple.isLoading
                ? PopupMenuButton(
                    ...
                    onSelected: (value) async {
                      if (value == 1) {
                        await Modular.to.pushNamed('./${restricao.id}/visualizar');
                        ...
                        Asuka.showDialog(
                          ...
                          builder: (context) {
                            return ConfirmationModalWidget(
                              ...
                              messages: translation.messages.excluirAEntidade(translation.fields.restricao, ArtigoEnum.artigoFeminino),
