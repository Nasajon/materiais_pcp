...
class MobileOperacaoEditarRestricaoWidget extends StatefulWidget {
  final RestricaoController restricaoController;
  final UnidadeEntity unidade;

  MobileOperacaoEditarRestricaoWidget({
    Key? key,
  ...
  @override
  State<MobileOperacaoEditarRestricaoWidget> createState() => _MobileOperacaoEditarRestricaoWidgetState();
}

class _MobileOperacaoEditarRestricaoWidgetState extends State<MobileOperacaoEditarRestricaoWidget> {
