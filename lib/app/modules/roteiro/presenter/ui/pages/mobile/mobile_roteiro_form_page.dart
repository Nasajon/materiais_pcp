...
import 'package:pcp_flutter/app/modules/roteiro/presenter/ui/pages/mobile/widgets/mobile_confirmacao_widget.dart';
import 'package:pcp_flutter/app/modules/roteiro/presenter/ui/pages/mobile/widgets/mobile_dados_basicos_form_widget.dart';
import 'package:pcp_flutter/app/modules/roteiro/presenter/ui/pages/mobile/widgets/mobile_periodo_form_widget.dart';
import 'package:pcp_flutter/app/modules/roteiro/presenter/ui/pages/mobile/widgets/mobile_operacao_painel_widget.dart';
    ...
    return RxBuilder(
      builder: (context) {
        ...
        return CustomScaffold.titleString(
          ...
          onClosePressed: () => checkPreviousRouteWeb(NavigationRouter.roteirosModule.path),
          body: Padding(
            ...
            builder: (context, triple) {
              ...
              if (roteiro != null && roteiro != RoteiroAggregate.empty() && !triple.isLoading) {
                Asuka.showSnackBar(
                  SnackBar(
                    content: Text(
                      translation.messages.criouAEntidadeComSucesso(translation.fields.roteiro),
                ...
                checkPreviousRouteWeb(NavigationRouter.roteirosModule.path);
              }
                              ...
                              Asuka.showDialog(
                                ...
                                builder: (context) {
                                  return ConfirmationModalWidget(
                                    ...
                                    onCancel: () => checkPreviousRouteWeb(NavigationRouter.roteirosModule.path),
                                  );
                                },
                              );
                            } else {
