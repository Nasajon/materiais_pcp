        ...
        builder: (context, triple) {
          ...
          return ListTileWidget(
                ...
                ? PopupMenuButton(
                    ...
                    onSelected: (value) {
                      if (value == translation.fields.visualizar) {
                        Modular.to.pushNamed(NavigationRouter.roteirosModule.updatePath(roteiro.id));
            ...
            onTap: !triple.isLoading
                ? () async {
                    await Modular.to.pushNamed(NavigationRouter.roteirosModule.updatePath(roteiro.id));
                  }
                : null,
          );
        });
