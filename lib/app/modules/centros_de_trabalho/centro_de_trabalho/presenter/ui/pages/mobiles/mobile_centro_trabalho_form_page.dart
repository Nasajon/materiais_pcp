...
class MobileCentroTrabalhoFormPage extends StatefulWidget {
  final String? id;
  ...
  const MobileCentroTrabalhoFormPage({
    Key? key,
    this.id,
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (id != null && centroTrabalhoController.centroTrabalho.id != id) {
        ...
        if (centroTrabalho != null) {
          ...
          centroTrabalhoController.centroTrabalho = this.oldCentroTrabalho.copyWith();
        } else {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormFieldWidget(
                  ...
                  isEnabled: centroTrabalhoController.isEnabled,
                  onChanged: (value) {
                    centroTrabalhoController.centroTrabalho = centroDeTrabalho.copyWith(nome: TextVO(value));
                  },
                ),
                const SizedBox(height: 16),
